                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        ...
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="?quanly=chitietsanpham&id=<?php echo $row_sanpham['sanpham_id']?>"
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        <h4 class="pt-1">
                                            <a
                                                href="?quanly=chitietsanpham&id=<?php echo $row_sanpham['sanpham_id']  ?>"><?php echo $row_sanpham['sanpham_name'] ?></a>
                                        </h4>
                                        <div class="info-product-price my-2">
                                            <span
                                                class="item_price"><?php echo number_format($row_sanpham['sanpham_giakhuyenmai']).'VNĐ' ?>
                                            </span> <br>
                    ...
                    <div class="left-side border-bottom py-2">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="span"> <a
                                        href="danhmucsanpham.php?id=<?php echo $row_category_slidebar['category_id']  ?> ">
                                        <?php echo $row_category_slidebar['category_name']  ?></a></span>
                            </li>
                            <?php } 
								?>
