		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
					<?php 
							$sqli_cate_home = mysqli_query($mysqli , "SELECT * FROM `tbl_category` ORDER BY category_id DESC");
							while($row_cate_home = mysqli_fetch_array($sqli_cate_home)){
					...
					?>
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<?php 
							$sqli_sanpham_home = mysqli_query($mysqli , "SELECT * FROM `tbl_sanpham` ORDER BY sanpham_id DESC");
							while($row_sanpham = mysqli_fetch_array($sqli_sanpham_home)){
									...
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsanpham&id=<?php echo $row_sanpham['sanpham_id']?>" class="link-product-add-cart">Xem sản phẩm</a>
												</div>
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo number_format($row_sanpham['sanpham_giakhuyenmai']).'VNĐ' ?> </span> <br>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
										<?php
										$sql_category_slidebar = mysqli_query($mysqli, 'SELECT * FROM `tbl_category` ORDER BY category_id DESC '); 
										while($row_category_slidebar = mysqli_fetch_array($sql_category_slidebar)){
										?>
								<li>
									
									<span class="span"> <a href="danhmucsanpham.php?id=<?php echo $row_category_slidebar['category_id']  ?> "> <?php echo $row_category_slidebar['category_name']  ?></a></span>
								</li>
								<?php } 
								?>
							...
							?>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="images/<?php echo $row_sanpham_slidebar['sanpham_image'] ?>" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											<a href=""><?php echo $row_sanpham_slidebar['sanpham_name'] ?>"</a>
											<a href="" class="price-mar mt-2"><?php echo number_format($row_sanpham_slidebar['sanpham_giakhuyenmai'])."vnd" ?></a>
											<del><?php echo number_format($row_sanpham_slidebar['sanpham_gia'])."vnd" ?> </del>
										</div>
									</div>
							<?php }
							?>
