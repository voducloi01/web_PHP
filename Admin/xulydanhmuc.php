                    ...
                    ?>
                        <div class="col-md-4">
                            ...
                            <form action="" method="POST">
                                <input type="text" name="danhmuc" class="form-control" value="<?php echo $row_capnhap['category_name'] ?>" placeholder="Tên danh mục">

                                <input type="hidden" name="id_danhmuc" class="form-control" value="<?php echo $row_capnhap['category_id'] ?>" placeholder="Tên danh mục">
                                <input type="submit" name="capnhatdanhmuc" class="btn btn-success" value="Cập nhập danh mục">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <a href="?xoa=<?php echo $row_category['category_id'] ?>">Xóa</a> || <a href="?quanly=capnhat&id=<?php echo $row_category['category_id'] ?>">Cập Nhập</a> </td>
                                </tr>
                            <?php } ?>
                        </table>
                    </div>
