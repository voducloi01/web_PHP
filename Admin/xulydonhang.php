...
<?php
        if(isset($_POST['capnhatdonhang'])){
            ...
            $sql_update_giaodich = mysqli_query($mysqli, "UPDATE tbl_giaodich SET tinhtrangdon='$xuly' WHERE magiaodich='$mahang_xuly'");


        } elseif (isset($_GET['xoadonhang'])){
...
<?php
        if (isset($_GET['xacnhanhuy']) && isset($_GET['mahang']) ) {
            ...
            $sql_update_donhang = mysqli_query($mysqli, "UPDATE tbl_giaodich SET huydon='$xacnhanhuy' WHERE magiaodich='$magiaodich'");
            $sql_update_giaodich = mysqli_query($mysqli, "UPDATE tbl_donhang SET huydon='$xacnhanhuy' WHERE mahang='$magiaodich'"); 
                ...
                <form action="" method="POST">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td> <?php echo number_format($row_donhang['soluong']*$row_donhang['sanpham_giakhuyenmai'])."vnd"  ?>
                            </td>
